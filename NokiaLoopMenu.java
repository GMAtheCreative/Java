		...
		if(switchOn.equalsIgnoreCase("ON")){
			...
			while(enter != 0){
				...
				while(menu != 14){
					...
					System.out.println("Do you wish to continue exloring..... press \"NO\" to stop");

					String toMenu = collect.nextLine();

					if(toMenu.equalsIgnoreCase("NO"))
						break;

					System.out.print("CHOOSE ANY MENU OF YOUR CHOICE \n" + mainMenu + "\n");
					menu = collect.nextInt();		
				}				

			

				System.out.println("Press 1 to go back to the MAIN MENU or 0 to quit");
				enter = collect.nextInt();
